...
public class KeyManagerFactoryHelper {
     ...
     * @throws Exception
     */
    public static SslContext defaultServerContext() {
     ...
     * @throws Exception
     */
    public static SslContext defaultClientContext() {
     ...
     * @throws Exception
     */
    public static SslContext createServerContext(String caPath, String caPassword) {
        try {
            ...
            throw new SslCreateException("创建ssl连接失败", e);
        }
    }
     ...
     * @throws Exception
     */
    public static SslContext createClientContext(String caPath, String caPassword) {
        try {
            keyStore.load(new FileInputStream(caPath), caPassword.toCharArray());
